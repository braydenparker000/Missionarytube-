...
for(const route of ['/jarvis/','/quick-ai/','/daily-board/','/drawercast/','/media/','/portal/','/notes/','/tools/','/settings/','/favorites/','/server/','/reader/','/respond/','/connect/']){
...
console.log(`Verified ${files.length} files byte-for-byte, MIME types, and 14 directory routes${cutover?' plus root':''}.`);
